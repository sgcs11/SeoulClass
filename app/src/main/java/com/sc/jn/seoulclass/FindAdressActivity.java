...
public class FindAdressActivity extends AppCompatActivity {
     ...
     */
    private LinearLayout mFetchAddressButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFetchAddressButton = (LinearLayout) findViewById(R.id.fetch_address_button);
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(FindAdressActivity.this,
